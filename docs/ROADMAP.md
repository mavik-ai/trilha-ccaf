...
- [x] `SPEC-014` — Admin/export de leads (view ou CSV).

**Bloco J · Engajamento**
- [x] `SPEC-013` — Recalcular plano preservando progresso (ancorado em `lesson_id`).
- [x] `SPEC-015` — Lembretes por email/WhatsApp (Brevo/Evolution) — *opcional, fast-follow.*
